...
__doc__ = """InterfaceMapWithLayer2Info

Gather IPv4 and IPv6 network interface information from SNMP,
and get Layer 2 information to bind interfaces to MACs of clients,
...
class InterfaceMapWithLayer2Info(SnmpPlugin):
    """
    Map IPv4 and IPv6 network names and aliases to DMD 'interface' objects,
    and adds Layer 2 information
    """
    order = 80
    compname = "os"
    relname = "interfaces"
    ...
    def process(self, device, results, log):
        ...
        self.addLayer2Info(log, iftable, dot1dTpFdbTable, dot1dBasePortEntry)
    ...
    def addLayer2Info(self, log, iftable, dot1dTpFdbTable, dot1dBasePortEntry):
        """
